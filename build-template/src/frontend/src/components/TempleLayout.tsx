...
export default function TempleLayout() {
    ...
    useDualAutoplayFallbackBackgroundAudio({
        primarySrc: publicAssetUrl('assets/generated/Micah Tyler - Praise The Lord (Official Music Video) - MicahTylerVEVO.mp3'),
        primaryVolume: 0.5,
        underlyingSrc: publicAssetUrl('assets/generated/unnecessary-religious-song-loop.mp3'),
        ...
        <MicroFeaturesProvider>
            <div className="relative min-h-screen overflow-x-hidden bg-parchment">
                ...
                <div 
                    ...
                    style={{
                        backgroundImage: `url(${publicAssetUrl('assets/generated/parchment-overlay-tile.dim_1024x1024.png')})`,
                ...
                <div 
                    ...
                    style={{
                        backgroundImage: `url(${publicAssetUrl('assets/generated/religious-doodle-tile.dim_1024x1024.png')})`,
                        backgroundRepeat: 'repeat',
                ...
                <div className="fixed left-0 top-0 bottom-0 w-[100px] md:w-[150px] pointer-events-none z-10">
                    <div 
                        ...
                        style={{ 
                            backgroundImage: `url(${publicAssetUrl('assets/generated/side-border.dim_200x1200.png')})`,
                    ...
                    <div 
                        ...
                        style={{
                            backgroundImage: `url(${publicAssetUrl('assets/generated/ancient-border-pattern-tile.dim_1024x1024.png')})`,
                            backgroundRepeat: 'repeat',
